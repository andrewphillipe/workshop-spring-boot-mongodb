...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "#partiu", "Vou viajar bla bla bla 1", us3);
		Post post2 = new Post(null, sdf.parse("22/04/2019"), "#partiu", "Vou viajar bla bla bla 2", us2);
		Post post3 = new Post(null, sdf.parse("23/05/2020"), "#partiu", "Vou viajar bla bla bla 3", us1);
